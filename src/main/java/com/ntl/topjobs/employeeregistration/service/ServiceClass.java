...
public class ServiceClass {
	...
	public List<EmployerSignupDetails> viewAllEmployers() {
		
		return dao.findAll();
	}
	
	public EmployerSignupDetails deleteEmployer(String id) {
		
		EmployerSignupDetails empobj=null;
		Optional<EmployerSignupDetails> optionals = dao.findById(id);
	      
		
		if(optionals.isPresent()){
             dao.deleteById(id);
             empobj= optionals.get();
		}
